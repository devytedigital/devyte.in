        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <motion.h1
              ...
              viewport={{ once: true }}
              className="text-5xl md:text-7xl font-light tracking-tight mb-8 leading-[0.9]"
            >
              We are{" "}
            ...
            <motion.p
              ...
              className="text-lg text-black/60 leading-relaxed max-w-md mb-12"
            >
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              Suspendisse est mi, maximus sit amet nibh ac, interdum tempus
              arcu. Ut urna dui, cursus et leo a, consequat consequat libero.
            </motion.p>
